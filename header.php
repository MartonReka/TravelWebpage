...
<body>
  	<header>
  		<div class="container">
			<div class="header">
				<div id="title">	
      				<h1>Travel in Sic village</h1>
                  <img src="https://www.123rf.com/photo_116780938_wooden-footbridge-crossing-the-reed-reserve-from-sic-village-near-cluj-napoca-romania.html" alt="Szek" width="500" height="333">  
      			</div>
      		<nav>
      			<ul>
    				<li><a href="index.html">Home</a></li>
    				<li><a href="about.html">Actual</a></li>
